...
AST_T* parser_parse_variable_definition(parser_T* parser, scope_T* scope)
{
    ...
    variable_definiton->variable_definition_variable_name = variable_definition_variable_name;
    variable_definiton->variable_definition_value = variable_definition_value;

    variable_definiton->scope = scope;
